...
function TotalRoutes() {
    ...
    const OrganisationDetailsRoutes = organisations.map((organisation) => {
        return {
            path: `/organisation-details-${organisation.id}`,
    ...
    const OwnedAppsRoutes = organisations.map((organisation) => {
        return {
            path: `/organisation-details-${organisation.id}-owned-apps`,
            Component: OwnedApps,
            organisationId: organisation.id,
            organisation: organisation,
        };
    ...
    const DevelopedAppsRoutes = organisations.map((organisation) => {
        return {
            path: `/organisation-details-${organisation.id}-developed-apps`,
            Component: DevelopedApps,
            organisationId: organisation.id,
            organisation: organisation,
        };
    });
    ...
    const organisationUpdateRoutes = organisations.map((organisation) => {
        return {
            path: `/organisation-update-${organisation.id}`,
