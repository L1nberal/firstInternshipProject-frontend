...
function Login() {
    ...
    const { user, googleSignIn, facebookSignIn, dataBaseLogin, error, setError } = useContext(AuthContext);
    ...
    const formSchema = Yup.object().shape({
        ...
        password: Yup.string().required('Bạn chưa nhập mật khẩu').min(6, 'mật khẩu phải dài ít nhất 6 kí tự'),
    });
