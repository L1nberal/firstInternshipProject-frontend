                    ...
                    return (
                        <React.Fragment key={app.id}>
                            {app.attributes.owner.data != null ? (
                                                        ...
                                                        <Link to={`/app-details-${app.id}`} state={{ app: app }}>
                                                            ...
                                                            >
                                                                ...
                                                                <div className={cx('list-item__status')}>
                                                                    {amountOfDays1 < 25 ? (
                                                                        <Badge bg="primary" className={cx('new')} pill>
                                                                            new
                                                                        </Badge>
                                                                    ) : (
                                                                        <Badge bg="primary" className={cx('old')} pill>
                                                                            old
                                                                        </Badge>
                                                                    )}
                                                                </div>
                                ...
                                <Link to={`/app-details-${app.id}`} state={{ app: app }}>
                                    <ListGroup.Item as="li" className={cx('list-item')} key={app.id}>
                                        <div className={cx('list-item__name')}>{app.attributes.name}</div>
