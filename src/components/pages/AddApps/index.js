            ...
            <div className={cx('wrapper')}>
                ...
                <Form className={cx('form')} onSubmit={handleSubmit(submitHandler)}>
                    ...
                    <Form.Group className={cx('form-group', 'mb-3', 'formBasic')} controlId="formBasic">
                        ...
                        />
                        {errors.description && (
                            <Form.Text className="text-muted">{errors.description.message}</Form.Text>
                        )}
                    </Form.Group>
                    ...
                    <Form.Group className={cx('form-group', 'mb-3', 'formBasic')} controlId="formBasic">
                        ...
                        />
                        {errors.androidLink && (
                            <Form.Text className="text-muted">{errors.androidLink.message}</Form.Text>
                        )}
                    </Form.Group>
                    ...
                    <Form.Group className={cx('form-group', 'mb-3', 'formBasic')} controlId="formBasic">
                        ...
                        <Form.Control
                            ...
                            className={cx('infor-input')}
                        />
                        {errors.iosLink && <Form.Text className="text-muted">{errors.iosLink.message}</Form.Text>}
                    </Form.Group>
                                        ...
                                        return (
                                            <React.Fragment key={category.id}>
                                                <Dropdown.Item
                                                    ...
                                                    onClick={() => {
                                                        let choice = $(`#dropdown-category-${category.id}`)[0]
                                                            .innerText;
                                                        setCategory(choice);
